      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-8 sm:mb-12 px-4">
            ...
            <Button size="lg" variant="outline" onClick={() => scrollToSection('contato')} className="w-full sm:w-auto border-white text-white font-semibold px-4 sm:px-6 md:px-8 py-3 sm:py-4 text-sm sm:text-base md:text-lg backdrop-blur-sm bg-green-800">
              Fale Conosco
            </Button>
          </div>
